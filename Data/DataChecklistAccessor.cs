...
{
    public static class DataChecklistAccessor
    {
        // Dummy bundles
        public static readonly List<ReleaseBundle> Bundles = new()
    {
        ...
        public static readonly Dictionary<int, List<ChecklistSection>> Checklists = new()
        {
            {
                1,
